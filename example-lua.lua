...
Main.new = {}
Main.main = function() 
  local bench = Bencher.new();
  bench:intArithmetic(50000000);
  __haxe_Log.trace("Hello World", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="Main.hx",lineNumber=6,className="Main",methodName="main"}));
end
