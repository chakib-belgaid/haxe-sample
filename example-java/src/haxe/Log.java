...
public class Log extends haxe.lang.HxObject
{
	...
	public Log()
	{
		//line 28 "/usr/local/share/haxe/std/haxe/Log.hx"
	...
	{
		//line 34 "/usr/local/share/haxe/std/haxe/Log.hx"
		java.lang.String str = haxe.root.Std.string(v);
		//line 35 "/usr/local/share/haxe/std/haxe/Log.hx"
		if (( infos == null )) 
		{
			//line 36 "/usr/local/share/haxe/std/haxe/Log.hx"
			return str;
		}
		
		//line 37 "/usr/local/share/haxe/std/haxe/Log.hx"
		...
		//line 38 "/usr/local/share/haxe/std/haxe/Log.hx"
		...
		//line 39 "/usr/local/share/haxe/std/haxe/Log.hx"
		return ( ( pstr + ": " ) + str );
	}
