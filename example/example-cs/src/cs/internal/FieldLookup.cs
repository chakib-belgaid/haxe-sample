...
namespace haxe.lang {
	public sealed class FieldLookup {
		...
		protected static int[] fieldIds = new int[]{105, 4745537, 4849249, 5393365, 5442204, 5594513, 57476627, 76061764, 87367608, 142301684, 302979532, 328878574, 359333139, 407283053, 452737314, 501039929, 520590566, 946786476, 1067353468, 1103412149, 1181037546, 1204816148, 1224901875, 1228056441, 1247875546, 1280845662, 1282943179, 1292082396, 1352786672, 1398464674, 1410173467, 1431819701, 1436822557, 1532710347, 1547539107, 1620824029, 1621420777, 1623148745, 1648581351, 1705629508, 1768617329, 1807134073, 1830310359, 1915412854, 1916009602, 1937159360, 1981972957, 2025055113, 2054707467, 2082663554, 2127021138};
		
		protected static string[] fields = new string[]{"i", "__a", "arr", "len", "map", "pop", "getEnumConstructs", "remove", "filter", "resize", "methodName", "iterator", "lastIndexOf", "hasNext", "reverse", "insert", "length", "toString", "splice", "copy", "join", "concat", "next", "enumConstructor", "push", "sort", "quicksort", "trig", "spliceVoid", "getEnumName", "doubleArithmetic", "createEnumIndex", "createEnum", "concatNative", "className", "__unsafe_get", "__unsafe_set", "indexOf", "fileName", "toDynamic", "allEnums", "intArithmetic", "customParams", "__get", "__set", "__hx_deleteField", "lineNumber", "unshift", "enumParameters", "shift", "slice"};
