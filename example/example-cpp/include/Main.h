...
class HXCPP_CLASS_ATTRIBUTES Main_obj : public hx::Object
{
	...
	public:
		...
		static void _hx___intArithmetic(int wamrup,int execution);
		static ::Dynamic _hx___intArithmetic_dyn();

		static void _hx___doubleArithmetic(int wamrup,int execution);
		static ::Dynamic _hx___doubleArithmetic_dyn();

		static void _hx___trig(int wamrup,int execution);
		static ::Dynamic _hx___trig_dyn();
