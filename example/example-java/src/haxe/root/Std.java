...
public class Std
{
	...
	{
		//line 30 "/usr/local/share/haxe/std/java/_std/Std.hx"
		if (( v == null )) 
		{
			//line 31 "/usr/local/share/haxe/std/java/_std/Std.hx"
			return haxe.lang.Runtime.eq(t, java.lang.Object.class);
		}
		
		//line 32 "/usr/local/share/haxe/std/java/_std/Std.hx"
		if (( t == null )) 
		{
			//line 33 "/usr/local/share/haxe/std/java/_std/Std.hx"
			return false;
		}
		
		//line 34 "/usr/local/share/haxe/std/java/_std/Std.hx"
		java.lang.Class clt = ((java.lang.Class) (t) );
		//line 35 "/usr/local/share/haxe/std/java/_std/Std.hx"
		if (( ((java.lang.Object) (clt) ) == ((java.lang.Object) (null) ) )) 
		{
			//line 36 "/usr/local/share/haxe/std/java/_std/Std.hx"
			return false;
		}
		
		//line 37 "/usr/local/share/haxe/std/java/_std/Std.hx"
		java.lang.String name = clt.getName();
		//line 39 "/usr/local/share/haxe/std/java/_std/Std.hx"
		{
			//line 39 "/usr/local/share/haxe/std/java/_std/Std.hx"
			...
			switch (__temp_hash3)
			{
				...
				case 64711720:
				{
					//line 46 "/usr/local/share/haxe/std/java/_std/Std.hx"
				...
				case 1063877011:
				{
					//line 48 "/usr/local/share/haxe/std/java/_std/Std.hx"
				...
				case -1325958191:
				{
					//line 42 "/usr/local/share/haxe/std/java/_std/Std.hx"
				...
				case 104431:
				{
					//line 44 "/usr/local/share/haxe/std/java/_std/Std.hx"
		...
		//line 51 "/usr/local/share/haxe/std/java/_std/Std.hx"
		java.lang.Class clv = v.getClass();
		//line 53 "/usr/local/share/haxe/std/java/_std/Std.hx"
	...
	{
		//line 57 "/usr/local/share/haxe/std/java/_std/Std.hx"
	...
	{
		//line 61 "/usr/local/share/haxe/std/java/_std/Std.hx"
		return ((int) (x) );
	}
