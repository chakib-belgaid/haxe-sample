...
public class Runtime
{
	...
	static
	{
		//line 61 "/usr/local/share/haxe/std/java/internal/Runtime.hx"
	...
	{
		//line 132 "/usr/local/share/haxe/std/java/internal/Runtime.hx"
		if (( obj == null )) 
		{
			//line 132 "/usr/local/share/haxe/std/java/internal/Runtime.hx"
			return false;
	...
	{
		//line 145 "/usr/local/share/haxe/std/java/internal/Runtime.hx"
		if (( obj == null )) 
		{
			//line 145 "/usr/local/share/haxe/std/java/internal/Runtime.hx"
			return ((long) (0) );
	...
	{
		//line 172 "/usr/local/share/haxe/std/java/internal/Runtime.hx"
	...
	{
		//line 163 "/usr/local/share/haxe/std/java/internal/Runtime.hx"
		if (( obj instanceof java.lang.Number )) 
		{
			//line 164 "/usr/local/share/haxe/std/java/internal/Runtime.hx"
			java.lang.Number n = ((java.lang.Number) (obj) );
			//line 165 "/usr/local/share/haxe/std/java/internal/Runtime.hx"
			return ( n.doubleValue() == n.intValue() );
		}
		else
		{
			//line 167 "/usr/local/share/haxe/std/java/internal/Runtime.hx"
			return false;
		}
	...
	{
		//line 570 "/usr/local/share/haxe/std/java/internal/Runtime.hx"
		if (( obj == null )) 
		{
			//line 571 "/usr/local/share/haxe/std/java/internal/Runtime.hx"
			return null;
		}
		
		//line 573 "/usr/local/share/haxe/std/java/internal/Runtime.hx"
		if (( ( ( obj instanceof java.lang.Number ) &&  ! (( obj instanceof java.lang.Integer ))  ) && haxe.lang.Runtime.isInt(((java.lang.Number) (obj) )) )) 
		{
			//line 574 "/usr/local/share/haxe/std/java/internal/Runtime.hx"
			return java.lang.Integer.toString(((int) (haxe.lang.Runtime.toInt(obj)) ));
		}
		
		//line 575 "/usr/local/share/haxe/std/java/internal/Runtime.hx"
		return obj.toString();
	}
	...
	{
		//line 580 "/usr/local/share/haxe/std/java/internal/Runtime.hx"
		if (( v == v )) 
		{
			//line 580 "/usr/local/share/haxe/std/java/internal/Runtime.hx"
	...
	{
		//line 584 "/usr/local/share/haxe/std/java/internal/Runtime.hx"
		if (( n == null )) 
		{
			//line 584 "/usr/local/share/haxe/std/java/internal/Runtime.hx"
			return 0;
	...
	{
		//line 588 "/usr/local/share/haxe/std/java/internal/Runtime.hx"
		if (( n == null )) 
		{
			//line 588 "/usr/local/share/haxe/std/java/internal/Runtime.hx"
			return 0.0;
	...
	{
		//line 592 "/usr/local/share/haxe/std/java/internal/Runtime.hx"
		if (( n == null )) 
		{
			//line 592 "/usr/local/share/haxe/std/java/internal/Runtime.hx"
			return ((long) (0.0) );
	...
	{
		//line 596 "/usr/local/share/haxe/std/java/internal/Runtime.hx"
		if (( num == null )) 
		{
			//line 596 "/usr/local/share/haxe/std/java/internal/Runtime.hx"
			return null;
	...
	{
		//line 600 "/usr/local/share/haxe/std/java/internal/Runtime.hx"
		if (( num == null )) 
		{
			//line 600 "/usr/local/share/haxe/std/java/internal/Runtime.hx"
			return null;
	...
	{
		//line 604 "/usr/local/share/haxe/std/java/internal/Runtime.hx"
		if (( num == null )) 
		{
			//line 604 "/usr/local/share/haxe/std/java/internal/Runtime.hx"
			return null;
	...
	{
		//line 608 "/usr/local/share/haxe/std/java/internal/Runtime.hx"
		if (( num == null )) 
		{
			//line 608 "/usr/local/share/haxe/std/java/internal/Runtime.hx"
			return null;
	...
	{
		//line 612 "/usr/local/share/haxe/std/java/internal/Runtime.hx"
		if (( num == null )) 
		{
			//line 612 "/usr/local/share/haxe/std/java/internal/Runtime.hx"
			return null;
	...
	{
		//line 616 "/usr/local/share/haxe/std/java/internal/Runtime.hx"
		if (( num == null )) 
		{
			//line 616 "/usr/local/share/haxe/std/java/internal/Runtime.hx"
			return null;
